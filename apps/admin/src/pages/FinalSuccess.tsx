...
export default function FinalSuccess() {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-[#F5F6F8] pb-32 font-sans text-gray-900">
            <div className="mx-auto flex w-full max-w-xl flex-1 flex-col items-center">
                <div className="flex flex-col items-center px-6 pt-16 md:pt-12">
                    ...
                    {/* Headers */}
                    <h1 className="mb-2 text-[28px] font-bold tracking-tight text-gray-900 md:text-3xl">
                        Vendor Registered
                    </h1>
                    ...
                    <div className="animate-in fade-in zoom-in relative aspect-4/3 w-full max-w-95 overflow-hidden rounded-2xl bg-gray-200 shadow-lg duration-500">
                        {isLoading ? (
