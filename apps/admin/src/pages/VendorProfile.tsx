...
export default function VendorProfile() {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-[#F5F6F8] pb-10 font-sans text-gray-900">
            {/* Header */}
            <div className="sticky top-0 z-20 flex items-center bg-[#F5F6F8] px-5 pt-12 pb-4">
                <button
                    onClick={() => navigate(-1)}
                    className="mr-3 rounded-full p-1 transition-colors hover:bg-gray-200"
                >
                    <svg
                        width="24"
                        height="24"
                ...
                <h1 className="text-[18px] font-bold tracking-tight">ROS ID: V{shortId}</h1>
            </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-5 rounded-2xl bg-white p-5 shadow-sm">
                        <div>
                            ...
                            <p className="text-[15px] font-bold text-gray-800">{vendor.fullName}</p>
                        </div>
                        <div>
                            <p className="mb-1 text-[12px] font-semibold text-gray-400">
                                Mobile Number
