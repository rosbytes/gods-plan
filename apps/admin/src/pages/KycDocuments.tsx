    ...
    return (
        <div className="flex min-h-screen flex-col bg-[#F5F6F8] pb-28 font-sans text-gray-900">
            <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col">
                ...
                <div className="mt-2 flex-1 space-y-6 overflow-y-auto px-5 md:px-8">
                    {/* ID Type */}
                    <div className="space-y-3">
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className={`flex-1 cursor-pointer rounded-[18px] border-2 py-4 text-[15px] font-semibold transition-all ${idType === "aadhar" ? "border-[#135B47] bg-white text-[#135B47]" : "border-transparent bg-white text-gray-400 hover:border-gray-200"}`}
                            >
                                Aadhar
                            </button>
                            <button
                                onClick={() => setIdType("pan")}
                                className={`flex-1 cursor-pointer rounded-[18px] border-2 py-4 text-[15px] font-semibold transition-all ${idType === "pan" ? "border-[#135B47] bg-white text-[#135B47]" : "border-transparent bg-white text-gray-400 hover:border-gray-200"}`}
                            >
                                PAN
                            </button>
                        </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex gap-4">
                            {/* Front Image */}
                            <label className="relative flex aspect-[1.3/1] flex-1 cursor-pointer flex-col items-center justify-center gap-2 overflow-hidden rounded-[18px] border-2 border-dashed border-gray-200 bg-white transition-colors hover:border-gray-300">
                                <input
                                    type="file"
                                    className="hidden"
                    ...
                    <div className="space-y-3">
                        ...
                        <label className="relative flex aspect-2/1 w-full cursor-pointer flex-col items-center justify-center gap-2 overflow-hidden rounded-[18px] border-2 border-dashed border-gray-200 bg-white transition-colors hover:border-gray-300 md:aspect-5/2">
                            <input
                                type="file"
                                className="hidden"
