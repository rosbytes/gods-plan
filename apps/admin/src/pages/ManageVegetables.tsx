                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {vegs?.items?.map((v) =>
                                editingVeg?.id === v.id ? (
                                    ...
                                    <div
                                        key={v.id}
                                        className="col-span-2 divide-y divide-gray-100 overflow-hidden rounded-2xl bg-white shadow-sm"
                                    >
                                        ...
                                        <div className="px-5 pt-3.5 pb-3.5">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setEditNameInHindi(e.target.value)}
                                                className="w-full bg-transparent text-[15px] font-semibold text-gray-800 focus:outline-none"
                                            />
                                        </div>
                                        <div className="px-5 pt-3.5 pb-3.5">
                                    ...
                                    >
                                        <div className="relative h-28 w-full bg-[#E8F3F0]">
                                            ...
                                            <button
                                                ...
                                                className="absolute top-2 right-2 rounded-lg bg-white/90 p-1.5 text-gray-500 shadow-sm transition-colors hover:text-[#135B47]"
                                            >
                                                <svg
                                                    width="14"
                                                    height="14"
