...
export default function Footer() {
  return (
    <footer className="w-full bg-[#0E4A34] py-12 text-white">
      <div className="container mx-auto flex flex-col items-center px-4 lg:px-20">
        ...
        {/* Legal & Support */}
        <div className="mt-6 mb-5 flex w-full flex-col items-center justify-center gap-4 text-sm text-gray-200 md:flex-row md:gap-8">
        ...
        {/* <span>Oneprovisiongrowth Pvt Ltd</span>
          <span>Kandira Bhawan, Bagret Colony Sanganer, Jaipur- 302029, Rajasthan</span> */}
      </div>
    </footer>
  );
}
